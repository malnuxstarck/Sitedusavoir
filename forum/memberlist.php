...
$convert_order = array('membre_pseudo', 'membre_inscrit',
'membre_post', 'membre_derniere_visite');
...
membre_inscrit, membre_post, membre_derniere_visite, online_id
FROM membres
...
<th class="derniere_visite"><strong>Dernière
visite</strong></th>
...
{
echo'<p>Ce le site et le forum ne contient aucun membre actuellement</p>';
}
?>
</div>
</body></html>